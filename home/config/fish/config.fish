...
alias pion='nvidia-settings --assign CurrentMetaMode="DP-4: 1920x1080 +0+0 {rotation=right, ForceCompositionPipeline=On, ForceFullCompositionPipeline=On}, DP-2: 1920x1200 +1080+0 {ForceCompositionPipeline=On, ForceFullCompositionPipeline=On}"'
alias pioff='nvidia-settings --assign CurrentMetaMode="DP-4: 1920x1080 +0+0 {rotation=right, ForceCompositionPipeline=Off, ForceFullCompositionPipeline=Off}, DP-2: 1920x1200 +1080+0 {ForceCompositionPipeline=Off, ForceFullCompositionPipeline=Off}"'
